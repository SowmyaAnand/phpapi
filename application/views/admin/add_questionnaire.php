        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-8 col-md-offset-2 content-header">
                ...
                ?>
                 ...
                 <form method="post" enctype="multipart/form-data" name="add_questionnaire" action="<?php echo base_url().'admin/add_questionnaire';?>">

                  <div class="form-group form-material floating " data-plugin="formMaterial">
                    <label class="floating-label" for="inputTitle">Title</label>
                    <input type="text" class="form-control empty"  id="questionnaire" name="questionnaire">
                  </div>  
                  <div class="form-group form-material floating " data-plugin="formMaterial">
